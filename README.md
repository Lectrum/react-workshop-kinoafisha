...
1. [Скачай и установи](https://nodejs.org/en/) **`Версию Node 12.19.0`**:
2. Выполни в консоли **`node -v`** и убедись, что установленная версия **`Node.js`**: **`12.19.0`**;
...
```bash
git clone https://github.com/Lectrum/react-workshop-kinoafisha.git
```

7. Перейди в проект, выполнив команду:

```bash
cd react-workshop-kinoafisha
```
